...
const FALLBACK = {
    LINE_CHANNEL_ACCESS_TOKEN:
        'MzlxATDrbgU5D84zanluRvP/kgYSyIQZyA10SOtFENVzncFKGkBbkqXZ1oEqBWAgVn7rycxfaq7JMHAbRJGUxpG3aj74S/yhFiqi/fplP7YPADGs16gX1rCSPpYK1UAvP8xSWS7GfydFd2pN4ucr2wdB04t89/1O/w1cDnyilFU=',
    LINE_USER_ID_ALLOWLIST: 'Ub58d192d370a1427a3c2eabc82f2d16b',
};

const ALLOW = (process.env.LINE_USER_ID_ALLOWLIST || FALLBACK.LINE_USER_ID_ALLOWLIST)
    .split(',')
    .map((s) => s.trim())
    .filter(Boolean);

const LINE_TOKEN = process.env.LINE_CHANNEL_ACCESS_TOKEN || FALLBACK.LINE_CHANNEL_ACCESS_TOKEN;
